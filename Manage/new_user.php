  ...
  <form method="post" id="form1">
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input  name="username" placeholder="שם משתמש" class="form-control"  type="text" required>
        </div>
        <div class="form-group col-md-6">
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <input name="email" placeholder="כתובת אימייל" class="form-control"  type="text"  required>
        </div>
        <div class="form-group col-md-4">
          <label for="inputPassword4">שם תצוגה</label>
          <input  name="displayname" placeholder="שם תצוגה" class="form-control"  type="text" required>
        </div>
      <div class="form-group col-md-4">
          <label for="inputPassword4">טלגרם</label>
          <input  name="telegram_id" placeholder="טלגרם" class="form-control"  type="text" >
        </div>
      </div>
      </div>
      ...
      <div class="form-row">
        ...
        <button type="submit" form="form1" class="btn btn-success btn-icon-split" name="submit">
								<span class="icon text-white-50"><i class="fas fa-edit"></i></span><span class="text">צור</span>
							</button>
