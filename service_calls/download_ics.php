<?php
  ...
  $url = "../service_calls/icap.php?date=$date&startTime=$startTime&endTime=$endTime&subject_ics=$subject_ics&body_ics=$body_ics&call_id=$call_id&location_ics=$location_ics&notes=$notes&tech_agent_name=$tech_agent_name&tech_agent_mail=$tech_agent_mail";
              ...
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-right">
                    <h2 class="card-title">קובץ זימון</h2>

                    <div class="card">
                    <div class="card-body">
הורדת קובץ זימון
<p><a class="btn btn-success btn-round" href="<?php echo $url ?>">לחץ להורדה</a></p>
<?php echo $notes ?>
חזרה למסך קריאות השירות
<p><a class="btn btn-success btn-round" href="../service_calls.php">לחץ לחזרה</a></p>
