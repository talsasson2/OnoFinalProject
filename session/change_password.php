<?php
   ...
   $ses_sql = mysqli_query($con,"select change_password from users where ID = '$id' ");
   ...
   {
    session_start();
    echo '<script>alert("יש להחליף סיסמה")</script>';
 
    if($_SERVER["REQUEST_METHOD"] == "POST") {
     $mypassword = mysqli_real_escape_string($con,$_POST['password']); 
 
     $sql = "UPDATE `db`.`users` SET `password` = '$mypassword', `change_password` = 'no' WHERE `ID` = '$id';";
         if (mysqli_query($con, $sql)) 
         {
             echo '<script>alert("סיסמה שונתה בהצלחה")</script>';
    ...
    echo '<script>alert("סיסמה לא שונתה...")</script>';
    header("location: ../index.php");
    ...
    <div class="main-panel">
      <div class="card text-center">
        <div class="card-header card-header-rose">
          <div class="card-body">
            <h4 class="card-title">שינוי סיסמה</h4>
            <p class="card-text">
            <div class="col d-flex justify-content-center">
                  ...
                  <form class="user" action = "" method = "post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" placeholder="סיסמה חדשה" name = "password" dir = "rtl">
                                        </div>
										<input type = "submit" class="btn btn-primary btn-user btn-block" value = " החלף סיסמה"/>
                                        </a>
